calculateDeformation MATLAB Python Package
...
2. Installing the calculateDeformation Package

A. Change to the directory that contains the file setup.py and the subdirectory 
calculateDeformation. If you do not have write permissions, copy all its contents to a 
...
3. Using the calculateDeformation Package

The calculateDeformation package is on your Python path. To import it into a Python 
